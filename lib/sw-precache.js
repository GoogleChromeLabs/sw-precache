 ...
 * @return {boolean}
 */
function match(filePath, filePathArray) {
  return filePathArray.some(function(otherFilePath) {
...
function generate(params, callback) {
  return new Promise(function(resolve, reject) {
    ...
    uniq(includedFilePathsArray).forEach(function(filePaths) {
      var filesAndSizesAndHashes = getFilesAndSizesAndHashesForFilePaths(
        filePaths,
        uniq(flatten(excludedFilePathsArray)),
