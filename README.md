...
Note2: If you are using a CDN (e.g. Cloudflare), it's better to set the caching level as [Ignore Query String](https://support.cloudflare.com/hc/en-us/articles/200168256-What-are-Cloudflare-s-caching-levels-): Delivers the same resource to everyone independent of the query string. Otherwise, you would encounter "double fetch" in every first load after you updated some assets. 
